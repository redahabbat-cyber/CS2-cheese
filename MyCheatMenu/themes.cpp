...
void Themes::ApplyRagnarokTheme() {
    ...
    // Neon Purple (#8B00FF)
    colors[ImGuiCol_CheckMark] = ImVec4(0.54f, 0.00f, 1.00f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.54f, 0.00f, 1.00f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.70f, 0.20f, 1.00f, 1.00f);

    // Buttons
    colors[ImGuiCol_Button] = ImVec4(0.15f, 0.15f, 0.17f, 0.40f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.54f, 0.00f, 1.00f, 0.30f);
    ...
    colors[ImGuiCol_TabHovered] = ImVec4(0.54f, 0.00f, 1.00f, 0.50f);
